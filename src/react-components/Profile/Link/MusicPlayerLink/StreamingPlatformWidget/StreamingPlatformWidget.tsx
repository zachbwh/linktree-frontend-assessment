...
const StreamingPlatformWidget: React.FunctionComponent<{ streamingPlatformSong: IStreamingPlatformSong }> = props => {
    ...
    switch(props.streamingPlatformSong.Platform) {
        case "spotify":
            streamingPlatformWidget = <iframe title="Spotify Player" src={props.streamingPlatformSong.AudioPlayerSongLink} width="100%" height="80" frameBorder="0" allowTransparency={true} allow="encrypted-media"></iframe>;
        break;
        case "apple-music":
